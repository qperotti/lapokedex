...
@app.task
def find_poi(coords, position, user_number):
	...
	if user_number == 1:
		username = 'mipokedex1@gmail.com'
		password = '***'
		auth_service='google'
	if user_number == 2:
		username = 'mipokedex2@gmail.com'
		password = '***'
		auth_service='google'
	if user_number == 3:
		username = 'mipokedex3@gmail.com'
		password = '***'
		auth_service='google'
	if user_number == 4:
		username = 'mipokedex4@gmail.com'
		password = '***'
		auth_service='google'
	...
	for coord in coords:
		...
		if len(response_dict['responses']) == 0:
			print(username)
			print(user_number)
			print(response_dict)
		if len(response_dict['responses']) > 0:
